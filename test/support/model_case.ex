defmodule A2billingRestApi.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import A2billingRestApi.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&A2billingRestApi.ErrorHelpers.translate_error/1)
